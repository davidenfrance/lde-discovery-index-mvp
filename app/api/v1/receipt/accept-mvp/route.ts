...
export async function POST(req: NextRequest) {
  try {
    ...
    return NextResponse.json({
      ...
      note: "Receipt accepted on settle-mvp. Signed receipts issued. This is not GENIUS USD and not an LDI query.",
    });
  } catch (err) {
    const message = err instanceof Error ? err.message : "receipt_accept_failed";
